...
<class class="welcome">
        <h2>
            <img src="c2.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="c2.jpg" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made by Mohit Peshwani 
